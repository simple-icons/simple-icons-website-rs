...
will-be-renamed-at = { $icon } will be renamed at v{ $version }
will-be-removed-at-extended = { $icon } will be removed at { $version } about { $date } (see { $pr })
will-be-renamed-at-extended = { $icon } will be renamed at { $version } about { $date } (see { $pr })
...
aka = AkA
dup = Duplicated brand
loc = ({ $lang }) Localized name
old = Old name
copy-alias = Copy { $icon } { $type } ({ $alias })
hide-copyable-aliases = Hide copyable aliases
show-copyable-aliases = Show copyable aliases
...
copy-as-base64 = Copy as base64 { $filetype }
copied = Copied
copy-brand-name = Copy brand name
extensions = Extensions
libraries = Libraries
copy-icon-modal-url = Copy icon modal URL
copy-icon-url = Copy icon URL
copy-icon-svg-path = Copy icon SVG path
legal = Legal
language = Language
