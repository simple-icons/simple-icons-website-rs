Feature: Grid loads more icons when scolling to footer
	...
	Scenario: Load the next pages of icons on scroll
		...
		When I scroll to the footer
		Then the default number of icons per page * 4 have been loaded
		When I scroll to the footer
		Then the default number of icons per page * 5 have been loaded
