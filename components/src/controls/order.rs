...
pub fn OrderControl() -> impl IntoView {
    ...
    view! {
        <div class="control">
            <label>{Signal::derive(move || i18n().tr("order"))}</label>
            <div class="flex flex-row">
                <ControlButtonSVGPath
                    title=Signal::derive(move || i18n().tr("sort-alphabetically"))
                ...
                <ControlButtonSVGPath
                    title=Signal::derive(move || i18n().tr("sort-by-color"))
                ...
                <ControlButtonSVGPath
                    title=Signal::derive(move || i18n().tr("sort-randomly"))
                ...
                {move || match search_signal().is_empty() {
                    ...
                    false => {
                        view! {
                            <ControlButtonSVGPath
                                title=Signal::derive(move || i18n().tr("sort-by-search-match"))
