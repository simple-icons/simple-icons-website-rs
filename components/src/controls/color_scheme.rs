...
pub fn ColorSchemeControl() -> impl IntoView {
    ...
    view! {
        <div class="control">
            <label>{Signal::derive(move || i18n().tr("theme"))}</label>
            <div>
                <ControlButtonSVGPath
                    title=Signal::derive(move || i18n().tr("light-color-scheme"))
                ...
                <ControlButtonSVGPath
                    title=Signal::derive(move || i18n().tr("dark-color-scheme"))
                ...
                <ControlButtonSVGPath
                    title=Signal::derive(move || i18n().tr("system-color-scheme"))
